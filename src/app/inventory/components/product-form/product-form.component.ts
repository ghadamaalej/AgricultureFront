...
import { InventoryProduct, ProductCategory } from '../../models/inventory.models';
...
export class ProductFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.form = new FormGroup({
      ...
      currentQuantity: new FormControl(this.product?.currentQuantity ?? 0, [Validators.required, Validators.min(0)]),
      ...
      datePeremption:  new FormControl(this.product?.datePeremption ?? null),
    });
  }
