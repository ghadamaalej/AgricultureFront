...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  menuItems = [
  { icon: 'fas fa-th-large',       label: 'Dashboard',    key: 'dashboard'   },
  { icon: 'fas fa-users',          label: 'Users',        key: 'users'       },
  { icon: 'fas fa-calendar-alt',   label: 'Events',       key: 'events'      },
  { icon: 'fas fa-hand-holding-usd', label: 'Loans',      key: 'loans'       },
  { icon: 'fas fa-store',          label: 'Marketplace',  key: 'marketplace' },
  { icon: 'fas fa-comments',       label: 'Community',    key: 'community'   },
  { icon: 'fas fa-truck',          label: 'Deliveries',   key: 'deliveries'  },
  { icon: 'fas fa-graduation-cap', label: 'Training',     key: 'training'    },
  { icon: 'fas fa-exclamation-circle', label: 'Claims',   key: 'claims'      },
  { icon: 'fas fa-stethoscope',    label: 'Appointments', key: 'appointments'},
  { icon: 'fas fa-chart-line',     label: 'Analytics',    key: 'analytics'   },
    ...
    new Chart(this.revenueChartRef.nativeElement, {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'Revenue ($)',
            data: [42000, 55000, 48000, 70000, 63000, 85000,
                   91000, 78000, 95000, 110000, 102000, 125000],
            borderColor: '#4caf50',
          ...
          {
            label: 'Expenses ($)',
            data: [28000, 32000, 30000, 41000, 38000, 50000,
                   54000, 46000, 58000, 65000, 60000, 72000],
            borderColor: '#ff8f00',
      ...
      options: {
        ...
        plugins: {
          legend: {
            position: 'top',
            labels: { font: { size: 12, family: 'Poppins' }, usePointStyle: true }
          },
    ...
    new Chart(this.usersChartRef.nativeElement, {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'New Farmers',
            data: [320, 410, 390, 520, 480, 610, 590, 670, 720, 800, 760, 920],
          ...
          {
            label: 'New Buyers',
            data: [180, 220, 200, 290, 260, 340, 310, 380, 420, 460, 440, 510],
            backgroundColor: 'rgba(255,143,0,0.75)',
            borderRadius: 6,
            borderSkipped: false,
          },
          {
            label: 'New Transporters',
            data: [60, 80, 75, 95, 88, 110, 105, 120, 135, 150, 142, 170],
  ...
  // ── Chart 3: Deliveries This Week (Bar horizontal-like via doughnut) ──
  ...
  // ── Chart 4: Product Categories (Radar) ──────────────────────
